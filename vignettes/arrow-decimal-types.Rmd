...
A base `data.frame` works too; a tibble is used here because pillar prints the
column's type, which makes it easy to confirm the decimal survived the crossing.
