...
`decimal` provides arbitrary-precision decimal vectors for R backed by
the vendored `mpdecimal` C library.
...
capabilities remain deferred and are documented in the package README
and vignettes.
